...
public class Ejercicio {
	...
	private void initialize() {
		...
		lblNewLabel_3.setBounds(10, 82, 94, 31);
		panel_1.add(lblNewLabel_3);
		
		JLabel lblNewLabel_2 = new JLabel("NÚMERO 2");
		lblNewLabel_2.setBounds(10, 51, 94, 21);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_1 = new JLabel("NÚMERO 1");
		lblNewLabel_1.setBounds(10, 10, 94, 31);
		panel_1.add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setBounds(107, 16, 55, 19);
		panel_1.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(107, 52, 55, 19);
		panel_1.add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setEditable(false);
		textField_2.setBounds(107, 88, 55, 19);
